...
app.controller('flextronics-purchase-orderCtrl', ['$scope','myservice','$http','$timeout',function ($scope,myservice,$http,$timeout) {
          ...
          $scope.onload=function(){
           ...
           $http.get("http://ec2-35-173-231-185.compute-1.amazonaws.com:3000/api/purchaseorder")
  .then(function(response) {
   ...
   $scope.failuer1=false
    ...
    $scope.first=true
           ...
           $http.get("http://ec2-35-173-231-185.compute-1.amazonaws.com:3000/api/purchaseorder/"+myservice.xxx)
  .then(function(response) {
          $scope.res = response.data;
